...
| — | [layout manifest and store-root freedom](2026-09-18-layout-manifest-and-store-root-design.md) | **proposed 2026-09-18 — awaiting review** — reader-first `agents.layout/v2`, role→path stores, `.context/` pilot for content vaults. Do not implement, release, or migrate before approval. |
